<template>
  <div class="flex p-6 px-6 mb-6 bg-weather-secondary dark:bg-weather-primary--light dark:text-text-primary--light rounded-md shadow-md duration-150 hover:scale-105 cursor-pointer">
