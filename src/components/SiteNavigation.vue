  ...
  >
    ...
    >
      ...
      <BaseModal :modalActive="modalActive" @close-modal="toggleModal">
        <div class="text-text-primary dark:text-text-primary--light">
    ...
    >
      ...
      >
        <p
          v-if="searchError"
          class="p-2 rounded-md text-text-secondary bg-alert"
        >
          <i class="fa-solid fa-triangle-exclamation" />
          Uh oh, something went wrong, please try again.
        </p>
        <p
          v-if="!serverError && querySearchResults.length === 0"
          class="p-2 rounded-md text-text-secondary bg-alert"
        >
          <i class="fa-solid fa-triangle-exclamation" />
        ...
        <template v-else>
          <li
            ...
            :key="searchResult.id"
            class="py-2 duration-150 hover:text-text-hover border-b-1 border-indigo-500 dark:border-text-primary--light cursor-pointer"
